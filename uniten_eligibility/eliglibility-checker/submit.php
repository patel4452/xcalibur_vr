<?php  
$count = count($_POST);
$subjectCount = $count - 8;

if($_POST['eleigibileResultCount']==$subjectCount){
   $result =  'result';
}else{
   $result = 'no result';
}
...
// echo $result;
// echo $_POST['eleigibileResultCount'];
// echo $subjectCount; exit;
            ...
            <div class="section-block">
               <div class="section-inner section-fit section-relative">
                  ...
                  <div class="widget item-absolute headline hidden-mobile " id="element-2591" data-at="headline">
                           ...
                           <h1>
                              <span class="x_56c6f2d0 x_64e665fe">
                                 <span class="x_a269ab78">
                                    <br>
                                   “Congratulations! You are <?php echo strtoupper($_POST['eleigibileResult']).' for '. $_POST['course']; ?>”<br>
                                   
                                </span>
                              </span>
                           </h1><br>
                           <h4 style="font-weight: normal;">Our counsellor will get in touch with you soon.</h4>
                        </div>
                     <?php }else if($_POST['eleigibileResult']=='Not Eligible'){?> 
                           ...
                           <div class="contents" style="margin-top: 38%;">
                              ...
                              <h1>
                                 <span class="x_56c6f2d0 x_64e665fe">
                                    <span class="x_a269ab78">
                                       <br>
                                      “Unfortunately, You are <?php echo strtoupper($_POST['eleigibileResult']).' for '. $_POST['course']; ?>”<br>
                              ...
                              <div class="contents" style="margin-top: 38%;">
                                 ...
                                 <h1>
                                    <span class="x_56c6f2d0 x_64e665fe">
                                       <span class="x_a269ab78">
                                          <br>
                                         “Your results are <b>NOT COMPLETE</b>.”<br>                                   
                                      </span>
                                    </span>
                                 </h1><br>
                                 <h4 style="font-weight: normal;">Please provide all results to check your eligibility.</h4>
                              </div>
                        <?php }
                     ?>   
                     ...
                     <?php } ?>
                     <a href="index.php"><button style="background: #E54225;color: #fff;display: block;padding: 0.5em 1em; text-decoration: none;    border-radius: 5px; font-size: 50%!important; border: 1px solid; float: right; margin-top: 10%;">Start Again</button></a>
