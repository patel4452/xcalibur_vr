...
<html lang="en">
  <head>
    ...
    <title>Jernih Residence Lead Collection Form</title>
  </head>
  <body>
    <div class="container">
      <header class="text-center mx-auto d-block">
		<img src="assets/logo_sunway.png" class="img-responsive" >
		<h2>Contact <strong>Sunway Property</strong> for more details </h2>
	  </header>
      <div class="form">
        <form id="form" method="post" name="submit-to-google-sheet" action="thankyou.php">
          ...
          <div class="row justify-content-center">
            <div class="submit">
			  ...
			  <input id="sbn_btn" class="btn btn-default btn-custom btn-primary" type="submit" value="Send to Sunway Property">
            </div>
          </div>
        </form>
      </div>
	...
	<script type="text/javascript">
    	...
    	const scriptURL = 'https://script.google.com/macros/s/AKfycbyL9iB7ArLZsVsP9ml3laDexBYLHIAY63EdcRIrp80UGNP2WnlF/exec'
