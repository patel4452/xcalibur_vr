	...
	<div class="container">
		<div class="row d-flex align-items-center">	
				...
				<div class="content-txt">				
					<?php if( $subtitle != '' ): ?>
			 		<span class="section-id rose-color wow fadeInUp" data-wow-delay="0.1s"><?php echo esc_attr($subtitle) ?></span>
		 		 	<?php endif; ?>		 			
					<h3 class="h3-xl wow fadeInUp" data-wow-delay="0.2s"><?php echo genemy_parse_text($title, array('tagclass' => genemy_default_color().'-color')) ?></h3>
				
					<p class="p-md grey-color wow fadeInUp" data-wow-delay="0.3s"><?php echo apply_filters( 'genemy_allowed_tag_for_input', $lead_text ); ?></p> 
			...
			<div class="<?php echo esc_attr($img_order) ?>">
				<?php if( $image != '' ): ?>
				<div class="content-img wow video-preview fadeInRight" data-wow-delay="0.4s">
					...
					<a class="video-popup2" href="<?php echo esc_url($url) ?>">
						<div class="video-btn-md wow fadeInUp"  data-wow-delay="0.5s">	
							<div class="video-block-wrapper">
								<div class="play-icon-<?php echo genemy_default_color(); ?>"><div class="ico-bkg"></div><i class="fas fa-play-circle"></i></div>
							</div>
						</div>						
