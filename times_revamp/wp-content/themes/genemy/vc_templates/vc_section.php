...
$section_params = genemy_vc_section_settings(true);
...
$output .= '<section ' . implode( ' ', $wrapper_attributes ) . '>'.$inner_before.'<div class="'.$full_width.'">';
$output .= wpb_js_remove_wpautop( $content );
$output .= '</div>'.$inner_after.'</section>';
$output .= $after_output;
