...
$atts = shortcode_atts( genemy_digital_strategy_shortcode_vc(true), $atts);
extract($atts);
$params = '';
if( $display == 'counter' ){
...
$content_order = ($position == 'yes')? 'col-md-6 col-lg-6 order-md-last order-lg-last' : 'col-md-6 ct-4-col';
$img_order = ($position == 'yes')? 'col-md-6 col-lg-6 content-left-img' : 'col-md-6 col-lg-6';
...
echo genemy_buffer_template_file('sections/digital-strategy.php', $atts);
?>