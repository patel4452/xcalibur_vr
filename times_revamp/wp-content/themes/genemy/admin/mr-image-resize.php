...
*/
add_action( 'delete_attachment', 'genemy_delete_resized_images' );
function genemy_image_resize( $url, $width = null, $height = null, $crop = true, $align = 'c', $retina = false ) {
    global $wpdb;
    // Get common vars (func_get_args() only get specified values)
    $common = genemy_common_info( $url, $width, $height, $crop, $align, $retina );
...
function genemy_common_info( $url, $width, $height, $crop, $align, $retina ) {
...
function genemy_delete_resized_images( $post_id ) {
