<?php
add_action( 'init', 'genemy_google_fonts_init' );
function genemy_google_fonts_init(){
    $ot_google_fonts_cache_key = 'genemyperchdevelopment';
...
function genemy_get_google_fonts_array(){
$genemy_fonts ='{
