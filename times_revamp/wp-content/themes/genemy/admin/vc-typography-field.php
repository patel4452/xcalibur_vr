...
/**
 * Class genemy_Vc_Font_Container
 * @since 4.3
 * vc_map examples:
 *  array(
 *        'type' => 'font_container',
 ...
 */
function genemy_get_vc_typography_value( $value ){
	$fields = array();
	$values = '';
	$font_container = new genemy_Vc_Font_Container();	
