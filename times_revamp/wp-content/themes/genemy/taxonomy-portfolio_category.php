    ...
    <?php get_template_part( 'template-parts/content', 'before' );  ?>
        ...
        <?php 
            if ( have_posts() ) : 
                ...
                genemy_portfolio_archive_content();
                ...
                while ( have_posts() ) : the_post();
                    ...
                    */
                    ?>
                    <div <?php post_class('portfolio-item col-md-6 col-lg-4 m-top-30 wow fadeInUp'); ?>  data-wow-delay="<?php echo intval($animation_duration) ?>ms">
