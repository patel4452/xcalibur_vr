            ...
            if ( $show_buttons ) {
              ...
              if ( $show_buttons ) {
                ...
                echo '<form method="post" action="' . str_replace( '&settings-updated=true', '', admin_url( 'themes.php?page=ot-theme-options' )) . '">';                  
                  ...
                  echo '<button type="submit" class="option-tree-ui-button button button-secondary left reset-settings" title="' . __( 'Reset Options', 'genemy' ) . '">' . __( 'Reset Options', 'genemy' ) . '</button>';
