          ...
          array(
            ...
            'pages'               => array( 
              ...
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Theme Options', 'genemy' ) ),

                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Theme Options', 'genemy' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Theme Options updated.', 'genemy' ) ),

                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Theme Options reset.', 'genemy' ) ),

                'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'Save Changes', 'genemy' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . __( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'genemy' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      ...
      array( 
        ...
        'page_title'      => __( 'OptionTree', 'genemy' ),

        'menu_title'      => __( 'OptionTree', 'genemy' ),
      ...
      array(
        ...
        'page_title'      => __( 'Settings', 'genemy' ),

        'menu_title'      => __( 'Settings', 'genemy' ),
        ...
        'updated_message' => __( 'Theme Options updated.', 'genemy' ),

        'reset_message'   => __( 'Theme Options reset.', 'genemy' ),

        'button_text'     => __( 'Save Settings', 'genemy' ),
        ...
        'sections'        => array(
          ...
          array(
            ...
            'title'       => __( 'Theme Options UI', 'genemy' )
        ...
        'settings'        => array(
          ...
          array(
            ...
            'label'       => __( 'Theme Options UI Builder', 'genemy' ),
          ...
          array(
            ...
            'label'       => __( 'Settings PHP File', 'genemy' ),
          ...
          array(
            ...
            'label'       => __( 'Layout Management', 'genemy' ),
      ...
      array(
        ...
        'page_title'      => __( 'Documentation', 'genemy' ),

        'menu_title'      => __( 'Documentation', 'genemy' ),
        ...
        'sections'        => array(
          ...
          array(
            ...
            'title'       => __( 'Creating Options', 'genemy' )
          ...
          array(
            ...
            'title'       => __( 'Function References', 'genemy' )
          ...
          array(
            ...
            'title'       => __( 'Layouts Overview', 'genemy' )
        ...
        'settings'        => array(
          ...
          array(
            ...
            'label'       => __( 'Overview of available Theme Option fields.', 'genemy' ),
          ...
          array(
            ...
            'label'       => __( 'Option types in alphabetical order & hooks to filter them.', 'genemy' ),
          ...
          array(
            ...
            'label'       => __( 'Function Reference:ot_get_option()', 'genemy' ),
          ...
          array(
            ...
            'label'       => __( 'Function Reference:get_option_tree()', 'genemy' ),
          ...
          array(
            ...
            'label'       => __( 'Code examples for front-end development.', 'genemy' ),
          ...
          array(
            ...
            'label'       => __( 'What\'s a layout anyhow?', 'genemy' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'genemy', 'invalid_border_width', sprintf( __( 'The %s input field for %s only allows numeric values.', 'genemy' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'genemy', 'invalid_hex', sprintf( __( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'genemy' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'genemy', 'invalid_dimension_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'genemy' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'genemy', 'invalid_spacing_' . $error, sprintf( __( 'The %s input field for %s only allows numeric values.', 'genemy' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to OptionTree', 'genemy' ) ),

      'remove_media_text'     => __( 'Remove Media', 'genemy' ),

      'reset_agree'           => __( 'Are you sure you want to reset back to the defaults?', 'genemy' ),

      'remove_no'             => __( 'You can\'t remove this! But you can edit the values.', 'genemy' ),

      'remove_agree'          => __( 'Are you sure you want to remove this?', 'genemy' ),

      'activate_layout_agree' => __( 'Are you sure you want to activate this layout?', 'genemy' ),

      'setting_limit'         => __( 'Sorry, you can\'t have settings three levels deep.', 'genemy' ),

      'delete'                => __( 'Delete Gallery', 'genemy' ), 

      'edit'                  => __( 'Edit Gallery', 'genemy' ), 

      'create'                => __( 'Create Gallery', 'genemy' ), 

      'confirm'               => __( 'Are you sure you want to delete this Gallery?', 'genemy' ),

      'date_current'          => __( 'Today', 'genemy' ),

      'date_time_current'     => __( 'Now', 'genemy' ),

      'date_close'            => __( 'Close', 'genemy' ),

      'replace'               => __( 'Featured Image', 'genemy' ),

      'with'                  => __( 'Image', 'genemy' )
...
if ( ! function_exists( 'ot_get_media_post_ID' ) ) {
  ...
  function ot_get_media_post_ID() {
    ...
    if ( $post_ID === false || empty( $post_ID ) ) {
      ...
      $post_ID = $wpdb->get_var( "SELECT ID FROM $wpdb->posts WHERE `post_title` = 'Media' AND `post_type` = 'genemy' AND `post_status` = 'private'" );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'genemy', array(

      'labels'              => array( 'name' => __( 'Option Tree', 'genemy' ) ),
        ...
        $settings = array(
          ...
          'settings' => array(
            ...
            array(
              ...
              'label'     => __( 'Sample Text Field Label', 'genemy' ),

              'desc'      => __( 'Description for the sample text field.', 'genemy' ),
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings updated.', 'genemy' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be saved.', 'genemy' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Settings Imported.', 'genemy' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Settings could not be imported.', 'genemy' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Data Imported.', 'genemy' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Data could not be imported.', 'genemy' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Imported.', 'genemy' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be imported.', 'genemy' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts Updated.', 'genemy' ) . '</p></div>';
        ...
        return '<div id="message" class="error fade below-h2"><p>' . __( 'Layouts could not be updated.', 'genemy' ) . '</p></div>';
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layouts have been deleted.', 'genemy' ) . '</p></div>';
      ...
      return '<div id="message" class="updated fade below-h2"><p>' . __( 'Layout activated.', 'genemy' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      ...
      'background'                => __('Background', 'genemy'),

      'border'                    => __('Border', 'genemy'),

      'box-shadow'                => __('Box Shadow', 'genemy'),

      'category-checkbox'         => __('Category Checkbox', 'genemy'),

      'category-select'           => __('Category Select', 'genemy'),

      'checkbox'                  => __('Checkbox', 'genemy'),

      'colorpicker'               => __('Colorpicker', 'genemy'),

      'colorpicker-opacity'       => __('Colorpicker Opacity', 'genemy'),

      'css'                       => __('CSS', 'genemy'),

      'custom-post-type-checkbox' => __('Custom Post Type Checkbox', 'genemy'),

      'custom-post-type-select'   => __('Custom Post Type Select', 'genemy'),

      'date-picker'               => __('Date Picker', 'genemy'),

      'date-time-picker'          => __('Date Time Picker', 'genemy'),

      'dimension'                 => __('Dimension', 'genemy'),

      'gallery'                   => __('Gallery', 'genemy'),

      'google-fonts'              => __('Google Fonts', 'genemy'),

      'javascript'                => __('JavaScript', 'genemy'),

      'link-color'                => __('Link Color', 'genemy'),

      'list-item'                 => __('List Item', 'genemy'),

      'measurement'               => __('Measurement', 'genemy'),

      'numeric-slider'            => __('Numeric Slider', 'genemy'),

      'on-off'                    => __('On/Off', 'genemy'),

      'page-checkbox'             => __('Page Checkbox', 'genemy'),

      'page-select'               => __('Page Select', 'genemy'),

      'post-checkbox'             => __('Post Checkbox', 'genemy'),

      'post-select'               => __('Post Select', 'genemy'),

      'radio'                     => __('Radio', 'genemy'),

      'radio-image'               => __('Radio Image', 'genemy'),

      'select'                    => __('Select', 'genemy'),

      'sidebar-select'            => __('Sidebar Select',  'genemy'),

      'slider'                    => __('Slider', 'genemy'),

      'social-links'              => __('Social Links', 'genemy'),

      'spacing'                   => __('Spacing', 'genemy'),

      'tab'                       => __('Tab', 'genemy'),

      'tag-checkbox'              => __('Tag Checkbox', 'genemy'),

      'tag-select'                => __('Tag Select', 'genemy'),

      'taxonomy-checkbox'         => __('Taxonomy Checkbox', 'genemy'),

      'taxonomy-select'           => __('Taxonomy Select', 'genemy'),

      'text'                      => __('Text', 'genemy'),

      'textarea'                  => __('Textarea', 'genemy'),

      'textarea-simple'           => __('Textarea Simple', 'genemy'),

      'textblock'                 => __('Textblock', 'genemy'),

      'textblock-titled'          => __('Textblock Titled', 'genemy'),

      'typography'                => __('Typography', 'genemy'),

      'upload'                    => __('Upload', 'genemy')
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      ...
      array(
        ...
        'label'   => __( 'Full Width (no sidebar)', 'genemy' ),
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      ...
      array(
        ...
        'label'     => __( 'Name', 'genemy' ),

        'desc'      => __( 'Enter the name of the social website.', 'genemy' ),
      ...
      array(
        ...
        'desc'      => __( 'Enter the text shown in the title attribute of the link.', 'genemy' ),
      ...
      array(
        ...
        'desc'      => sprintf( __( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'genemy' ), '<code>http://</code>' ),
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        ...
        add_settings_error( 'genemy', 'dynamic_css', sprintf( __( 'Unable to write to file %s.', 'genemy' ), '<code>' . $filepath . '</code>' ), 'error' );
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        ...
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'edit', 'genemy' ) . '">

          <span class="icon ot-icon-pencil"></span>' . __( 'Edit', 'genemy' ) . '

        </a>

        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Delete', 'genemy' ) . '">

          <span class="icon ot-icon-trash-o"></span>' . __( 'Delete', 'genemy' ) . '
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text">
            ...
            <div class="description">' . __( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text">
            ...
            <div class="description">' . __( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'genemy' ) . '</div>
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-select wide-desc">
            ...
            <div class="description">' . __( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textarea wide-desc">
            ...
            <div class="description">' . __( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textblock wide-desc">
            ...
            <div class="description">' . __( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'genemy' ) . '</div>
            ...
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . __( 'Add Choice', 'genemy' ) . '</a>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textblock wide-desc">
            ...
            <div class="description">' . __( '<strong>Settings</strong>: This will only affect the List Item option type.', 'genemy' ) . '</div>
            ...
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . __( 'Add Setting', 'genemy' ) . '</a>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text wide-desc">
            ...
            <div class="description">' . __( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-select wide-desc">
            ...
            <div class="description">' . __( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'genemy' ) . '</div>

            <div class="format-setting-inner">

              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">

                <option value="and" ' . selected( $operator, 'and', false ) . '>' . __( 'and', 'genemy' ) . '</option>

                <option value="or" ' . selected( $operator, 'or', false ) . '>' . __( 'or', 'genemy' ) . '</option>
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting-label">
            ...
            <h5>' . __( 'Image Source (Radio Image only)', 'genemy' ) . '</h5>
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-text no-desc">
            ...
            <div class="description">' . __( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'genemy' ) . '</div>
        ...
        <div class="format-settings">
          ...
          <div class="format-setting type-textarea no-desc">
            ...
            <div class="description">' . __( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'genemy' ) . '</div>
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : __( 'Layout', 'genemy' ) ) . '</div>

      <div class="button-section">

        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . __( 'Activate', 'genemy' ) . '">

          <span class="icon ot-icon-square-o"></span>' . __( 'Activate', 'genemy' ) . '
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . __( 'New Layout', 'genemy' ) . '">' . __( 'New Layout', 'genemy' ) . '</button>';
  ...
  if ( $force_rebuild || ! is_array( $ot_google_fonts ) || empty( $ot_google_fonts ) ) {
    ...
    $ot_google_fonts_query_args = array(
      ...
      'sort'   => $ot_google_fonts_sort
        ...
        $ot_google_fonts_data = json_decode( trim( genemy_get_google_fonts_array() ), true );
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'fields'    => array(
      ...
      array(
        ...
        'desc'    => __( 'Source Name (ex. author, singer, actor)', 'genemy' ),
      ...
      array(
        ...
        'desc'    => __( 'Source Title (ex. book, song, movie)', 'genemy' ),
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'fields'    => array(
      ...
      array(
        ...
        'desc'    => sprintf( __( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'genemy' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'genemy' ) .'</a>', '<code>[video]</code>' ),
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'fields'    => array(
      ...
      array(
        ...
        'desc'    => sprintf( __( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'genemy' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . __( 'Wordpress Codex', 'genemy' ) .'</a>', '<code>[audio]</code>' ),
