...
*/
add_action( 'vc_before_init', 'genemy_section_title_shortcode_vc' );
function genemy_section_title_shortcode_vc( $return = false ) {
    $args = array(
        'icon' => 'genemy-icon',
        'name' => __( 'Section title', 'genemy' ),
        'base' => 'genemy_section_title',
        'class' => 'genemy-vc',
        ...
        'params' => array(            
            ...
            array(
                'type' => 'textarea',
                'value' => 'An enim nullam tempor sapien gravida donec enim ipsum blandit porta justo integer odio velna vitae auctor integer congue magna at purus',
                'heading' => 'Subtitle',
                'param_name' => 'subtitle',
                'admin_label' => true 
            ),
...
class WPBakeryShortCode_Genemy_section_title extends WPBakeryShortCode {
}