...
* The VC Functions
*/
add_action( 'vc_before_init', 'genemy_why_choose_shortcode_vc' );
function genemy_why_choose_shortcode_vc( $return = false ) {
    $args = array(
        'icon' => 'genemy-icon',
        'name' => __( 'Why choose', 'genemy' ),
        'base' => 'genemy_why_choose',
        'class' => 'genemy-vc',
        ...
        'params' => array(
            ...
            array(
                ...
                'param_name' => 'image',
                'description' => '',
                'value' => GENEMY_URI . '/images/image-07.png',
                'group' => __( 'Image options', 'genemy' ), 
            ),
            array(
                'type' => 'checkbox',
            ...
            array(
                ...
                'param_name' => 'title',
                'value' => 'Set your business in motion today',
                'admin_label' => true,
                'group' => __( 'Content', 'genemy' ), 
            ),
            array(
...
class WPBakeryShortCode_Genemy_why_choose extends WPBakeryShortCode {
}