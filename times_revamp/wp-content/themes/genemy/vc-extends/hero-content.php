...
* The VC Functions
*/
add_action( 'vc_before_init', 'genemy_hero_content_shortcode_vc' );
function genemy_hero_content_shortcode_vc( $return = false ) {
    $params =  array(  
        array(
            'type' => 'dropdown',
        ...
        array(
            ...
            'param_name' => 'image',
            'value' => GENEMY_URI. '/images/hero-17-img.png',
            'group' => __( 'Right-side option', 'genemy' ), 
            'dependency' => array(
                'element' => 'right_content_type',
                'value' => 'image' 
    ...
    $args = array(
        ...
        'name' => __( 'Hero content', 'genemy' ),
        'base' => 'genemy_hero_content',
        'class' => 'genemy-vc',
        'category' => __( 'Genemy', 'genemy' ),
        'description' =>  __( 'Display title & subtitle, button, form, image etc.', 'genemy' ),
        'params' => $params
    );
...
class WPBakeryShortCode_Genemy_hero_content extends WPBakeryShortCode {
}