...
$classArr = array('navbar', 'navbar-expand-lg', 'hover-menu' );
...
<header id="header" class="header navbar-style1">
	<nav class="<?php echo implode(' ', $classArr) ?>">
		<div class="container">
			...
			<!-- logo -->
	 		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="navbar-brand logo-white" rel="home"><img src="<?php echo esc_url($logo_white); ?>" height="30" alt="<?php bloginfo( 'name' ); ?>"></a>
	 		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="navbar-brand logo-black" rel="home"><img src="<?php echo esc_url($logo); ?>" height="30" alt="<?php bloginfo( 'name' ); ?>"></a>
	 		...
	 		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"><i class="fas fa-bars"></i></span></button>
	  		 ...
	  		 $args = array(
	            ...
	            'container_class' => 'collapse navbar-collapse txt-700 rose-hover',
	            'menu_class'      => 'navbar-nav ml-auto',
	            'theme_location'  => 'primary',
	            'depth'           => 2,
	            'walker'          => new Genemy_Walker_Menu(),
	            'fallback_cb'     => 'Genemy_Walker_Menu::fallback',
	            'items_wrap' => '<ul id="%1$s" class="%2$s">%3$s'.$searchicon.$cart.$icons.$button.'</ul>',
	          );
