	...
	function modal_theme_special_offer( $atts, $content = null ) {
		...
		<div class="cp-row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cp-text-container " >
				...
				?>
					">
					<div class="cp-description cp_responsive" style="background-color:<?php echo esc_attr( $a['modal_title_bg_color'] ); ?> ;border-top-color:<?php echo esc_attr( $a['modal_title_bg_color'] ); ?> " ><?php echo do_shortcode( html_entity_decode( $a['modal_short_desc1'], ENT_QUOTES, 'utf-8' ) ); ?></div>
				</div>
				...
				?>
					...
					if ( '' === trim( $a['modal_content'] ) ) {
						echo 'cp-empty'; }
					?>
						" ><?php echo do_shortcode( html_entity_decode( $a['modal_content'], ENT_QUOTES, 'utf-8' ) ); ?></div>
					</div>
