...
function cp_is_style_visible( $settings ) {
	...
	if ( $show_module && $show_countries ) {
		...
		if ( $global_display ) {
			...
			if ( is_front_page() ) {
				if ( is_array( $exclude_from ) && in_array( 'front_page::Front Page', $exclude_from ) ) {
					$display = false;
				}
			}
			if ( is_home() ) {
				if ( is_array( $exclude_from ) && in_array( 'blog::Blog / Posts Page', $exclude_from ) ) {
					$display = false;
				}
			}
			if ( is_author() ) {
			...
			if ( is_front_page() ) {
				if ( is_array( $exclusive_on ) && in_array( 'front_page::Front Page', $exclusive_on ) ) {
					$display = true;
				}
			}
			if ( is_home() ) {
				if ( is_array( $exclusive_on ) && in_array( 'blog::Blog / Posts Page', $exclusive_on ) ) {
					$display = true;
				}
			}
			if ( is_author() ) {
