...
function render_multi_social_media( $uniq, $value ) {
	...
	$output .= '<span class="cp-tooltip-icon has-tip" data-position="right" title="This kind of access token is needed to modify and read app settings. It can also be used to publish Open Graph actions. It is generated using a pre-agreed secret between the app and Facebook and is then used during calls that change app-wide settings. You obtain an app access token via a server-to-server call." style="cursor: help;float: right;"><i class="dashicons dashicons-editor-help"></i></span>';
