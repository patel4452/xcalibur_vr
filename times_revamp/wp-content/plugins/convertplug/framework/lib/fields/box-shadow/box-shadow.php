						...
						<div class="switch-wrapper shadow_type">
							...
							<p><select name="shadow_type" id="smile_shadow_type" class="form-control smile-input smile-select shadow_type">
								...
								foreach ( $options as $text_val => $val ) {
									...
									?>
									<option class="smile_<?php echo esc_attr( $val ); ?>" "<?php echo esc_attr( $selected ); ?>" value="<?php echo esc_attr( $val ); ?>"><?php echo esc_html( htmlspecialchars( $text_val, ENT_QUOTES, 'utf-8' ) ); ?></option>
									<?php } ?>      
								</select></p>            
							</div>
						</div>
