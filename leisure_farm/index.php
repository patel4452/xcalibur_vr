  ...
  <body>
    <div class="container">
      <header class="text-center mx-auto d-block">
		...
		<h2>Contact <strong>Leisure Farm</strong> for more details </h2>
	  </header>
      <div class="form">
        <form id="form" method="post" name="submit-to-google-sheet" action="thankyou.php">
          ...
          <div class="row justify-content-center">
            <div class="submit">
			  ...
			  <input id="sbn_btn" class="btn btn-default btn-custom btn-primary" type="submit" value="Send to Leisure Farm">
            </div>
          </div>
        </form>
      </div>
	...
	<script type="text/javascript">
    	...
    	const scriptURL = 'https://script.google.com/macros/s/AKfycbzuqzXNlMc6-jjGLf7VhjaoxNEFwPqKul0ZrnfkIdsZ2CLWIUSU/exec';
